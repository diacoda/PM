    ...
    public class TransactionService : ITransactionService
    {
        ...
        /*
                public async Task AddTransactionAsync(
                    ...
                    bool applyToCash = true,
                    CancellationToken ct = default)
                {
                    IncludeOption[] includes = new IncludeOption[] { IncludeOption.Holdings };
                    Account account = await _accountRepo.GetByIdWithIncludesAsync(accountId, includes, ct);
                    if (account == null)
